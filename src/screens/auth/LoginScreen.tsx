      ...
      <View style={dynamicStyles.content}>
        ...
        <View style={dynamicStyles.mainContent}>
          ...
          <TouchableOpacity
            ...
            disabled={otpSent}
          >
            <Text style={dynamicStyles.countryFlag}>
          ...
          <View style={dynamicStyles.otpReservedSpace}>
            ...
            >
              {/* Enter OTP Text */}
              <Text style={dynamicStyles.otpInstructionText}>
                ...
                {otp.map((digit, index) => (
                  <TextInput
                    ...
                    style={[
                      ...
                      digit && dynamicStyles.otpInputFilled,
        ...
        <View style={dynamicStyles.bottomSection}>
          ...
          <View style={dynamicStyles.buttonContainer}>
            {!otpSent ? (
              ...
              <View style={dynamicStyles.otpButtonContainer}>
                {/* Verify OTP Button */}
                <TouchableOpacity
                  style={[
                    dynamicStyles.verifyButton,
                    otpLoading && dynamicStyles.verifyButtonDisabled,
                  ]}
